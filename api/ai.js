...
export default async function handler(req,res){
 ...
 try{
  ...
  const pdfOutputRule=title==='Gerador de PDF'?'\n\nRetorne somente o texto final do material, sem JSON, sem código Markdown e sem escrever o nome da ferramenta no início. Use títulos em linhas separadas, parágrafos curtos e listas simples.':'';
